...
*Yes. The values differ from the estimates from the first part of the assignment. However, notice that the mean and median of the imputed data set are equal.*
